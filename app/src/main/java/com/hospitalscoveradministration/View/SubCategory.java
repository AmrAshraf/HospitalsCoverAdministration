...
public class SubCategory extends AppCompatActivity implements AdapterCategoryInterface {
    ...
    private void initListener() {
        ...
        modelView.getSubCategory().observe(this, new Observer<com.hospitalscoveradministration.Model.SubCategory>() {
            @Override
            public void onChanged(@Nullable com.hospitalscoveradministration.Model.SubCategory subCategory) {
                hideProgress();
                if (subCategory != null) {
